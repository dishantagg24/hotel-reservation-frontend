...
const FeaturedProperties = () => {
  return (
    <div className="fp">
      ...
      <div className="fpItem">
        <img
          src="https://images.unsplash.com/photo-1615873968403-89e068629265?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1032&q=80"
          alt=""
          className="fpImg"
        />
